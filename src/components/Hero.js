  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[#0a0a0a] text-white overflow-hidden" id="home">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-purple-600/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 z-10 pt-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
          ...
          <div className="flex-[1.2] order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              <span className="h-[2px] w-10 bg-blue-500 rounded-full"></span>
              <span className="text-blue-400 font-mono text-sm tracking-[0.3em] uppercase font-bold">Software Engineer</span>
            </motion.div>
            ...
            <motion.h1 
              ...
              className="text-6xl md:text-9xl font-black tracking-tighter mb-6 leading-[0.9]"
            >
            ...
            <motion.div 
              ...
              className="text-2xl md:text-3xl text-gray-400 font-light mb-10 h-16"
            >
              Building{' '}
              <TypeAnimation
                sequence={[
                  'scalable systems.', 2000,
                  'clean interfaces.', 2000,
                  'MERN solutions.', 2000,
                ]}
                repeat={Infinity}
                className="text-white font-semibold underline decoration-blue-500/50 underline-offset-8"
              />
            </motion.div>
            ...
            >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="group flex items-center gap-3 text-gray-400 hover:text-white transition-all py-2"
              >
          ...
          {/* Right Content: The Big Portrait */}
          <motion.div 
          ...
          >
            <div className="relative group">
              ...
              <motion.div 
                ...
                className="absolute -bottom-2 -right-2 md:bottom-10 md:-right-8 bg-black/60 backdrop-blur-2xl border border-white/10 px-6 py-4 rounded-3xl shadow-2xl z-20"
              >
        ...
        <motion.div 
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 cursor-pointer p-2 rounded-full border border-white/10 hover:border-blue-500/50 transition-colors group"
        >
          <ArrowDown size={24} className="text-gray-500 group-hover:text-blue-400 transition-colors" />
        </motion.div>
      </div>
    </section>
  );
